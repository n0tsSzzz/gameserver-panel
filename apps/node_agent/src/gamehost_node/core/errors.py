...
from gamehost_node.domain.exceptions import NodeAgentError
...
def register_exception_handlers(app: FastAPI) -> None:
    @app.exception_handler(NodeAgentError)
    async def _domain(_request: Request, exc: NodeAgentError) -> JSONResponse:
